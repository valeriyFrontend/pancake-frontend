    ...
    return (
      <>
        ...
        <div className="flex flex-col w-full justify-center items-center px-5 mt-7">
          {isLoading && (
            <div className="flex items-center w-full rounded-xl p-4 mb-2">
    ...
    return (
      <>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="mt-4 rounded-xl overflow-y-auto w-full webkit-scrollbar ">
        ...
        {explorerLink ? (
          <a
            ...
            className="cursor-pointer mt-2 ml-2 text-xs hover:underline pcs-explorer-link"
          >
            View on {explorer}
          </a>
        ) : null}
      ...
      {errorMessage || txStatus?.status === 'fail' ? (
        <div className="flex justify-center">
          <div className="flex flex-col items-center justify-center text-center mt-12">
            ...
            <p className="mt-2">Swap Failed</p>
            <p className="text-xs mt-2">We were unable to complete the swap, please try again.</p>
      ...
      {!errorMessage && txStatus?.status === 'timeout' ? (
        <div className="flex justify-center">
          <div className="flex flex-col items-center justify-center text-center mt-12">
            ...
            <p className="mt-2">Transaction timed-out</p>
            <p className="text-xs mt-2">We were unable to complete the swap, please try again.</p>
