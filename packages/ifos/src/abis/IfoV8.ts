export const ifoV8ABI = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct IFOInitializableV8.VestingSchedule',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'thresholdPoints', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  { inputs: [], name: 'revoke', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
      ...
      { internalType: 'uint8', name: '_pid', type: 'uint8' },
      { internalType: 'enum IIFOV8.SaleType', name: '_saleType', type: 'uint8' },
      {
        components: [
        ...
        internalType: 'struct IIFOV8.VestingConfig',
        name: '_vestingConfig',
        type: 'tuple',
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: 'struct IIFOV8.PointConfig',
        name: '_pointConfig',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: '', type: 'uint256' },
      { internalType: 'uint256', name: '', type: 'uint256' },
      { internalType: 'enum IIFOV8.SaleType', name: '', type: 'uint8' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
