...
import { InfinityRoute } from '../types'

export function isSameRoute(one: InfinityRoute, another: InfinityRoute) {
...
export function mergeRoute(one: InfinityRoute, another: InfinityRoute): InfinityRoute {
  return {
    ...one,
