...
export const appLayoutPaddingX = ['16px', `max((100vw - ${contentWidth}) / 2, 3%)`, `max((100vw - ${contentWidth}) / 2, 5%)`]
export const revertAppLayoutPaddingX = ['-20px', `min((100vw - ${contentWidth}) / -2, -3%)`, `min((100vw - ${contentWidth}) / -2, -5%)`]
